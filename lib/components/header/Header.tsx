        ...
        <div>
            ...
            <div className={desktopHeaderStyle}>
                ...
                <div className="flex flex-row items-center w-full gap-2">
                    <NavLink label="Website" isExternal={true} link="https://ralphthemoose.com/" leftIcon={false} icon={<IconMenu />}/>
                    ...
                    <DropdownTrigger title="Network" expanded={false} selectedOption="Base" variant="large" icon={<IconNetworkBase/>} defaultColor="text-base-colors/neutral-900" />
                </div>
            </div>
